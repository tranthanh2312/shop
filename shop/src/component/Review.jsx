        ...
        <div className=" mx-auto max-w-screen-xl px-4  sm:px-6 lg:px-8 py-2">
          <div className="px-2">
            <div className="mx-auto text-center">
              <h4 className="text-3xl font-bold py-2.5">
                Read trusted reviews from <br /> our customers
              </h4>
              <p className="mx-auto mt-4 max-w-lg">
                ...
                harum dolore reprehenderit quis! Quo totam dignissimos <br />
                earum.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 grid-rows-2 gap-10 lg:grid-cols-3 grid-rows-1">
              <div className="mt-12">
                <img
